...
export const CAMERAS: Camera[] = [
  ...
  { id: "gits-hub", name: "경기도 도로", region: "경기", group: "gyeonggi", source: "경기도 교통정보센터", playMode: "outbound", url: "https://gits.gg.go.kr/web/trafficInfo/webMapInfo.do?opt=3", lat: 37.29, lng: 127.03, note: "경기도 OpenAPI와 공식 팝업은 공개키 신청이 필요합니다. 키 없이 허브에 붙일 수 없습니다." },
